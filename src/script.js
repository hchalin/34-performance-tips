...
// // Tip 12
/**
 * This will render only one shadow map on the first
 * render and NOT update on every frame.
 * Good for performances if you have static objs
 */
  ...
  precision: 'lowp', //this can help
    ...
    vertexShader: `
        ...
        void main()
        {
            ...
            //OLD (stay away from 'if' statements)
            // if(elevation < 0.5)
            // {
            //     elevation = 0.5;
            // }
            //NEW (this is better)
            elevation = clamp(elevation, 0.5, 1.0) * uDisplacementStrength;
